...
- element_tip은 사주 오행의 상생상극(相生相剋) 이론에 근거해서, 각자의 기운을 보완해줄 실제로 몸에 지닐 수 있는 색깔·소품·보석 등을 구체적으로 추천해. (예: "불의 기운이 과하면 물의 기운을 상징하는 검은색이나 남색 소품, 자수정을 지니면 감정 기복이 완화돼요") 미신스럽게 들리지 않게, 사주 명리학 전문가처럼 근거 있고 담백한 톤으로 1~2문장.
...

{
  ...
  "element_tip": {
    "me": "${me && me.n ? me.n : "A"}님의 기운을 보완해줄 색깔/소품/보석 추천 (오행 이론 근거, 1~2문장)",
    "partner": "${partner && partner.n ? partner.n : "B"}님의 기운을 보완해줄 색깔/소품/보석 추천 (오행 이론 근거, 1~2문장)"
  }
}`;
}
